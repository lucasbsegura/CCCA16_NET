...
namespace CCCA16_NET.Test.Domain
{
    public class AccountTest
    {
        ...
        {
            var createAccount = Account.Create(new Name(name), new Email(email), new Cpf(cpf), carPlate, isPassanger, isDriver);
        ...
        {
            var createAccount = Account.Restore(accountId, new Name(name), new Email(email), new Cpf(cpf), carPlate, isPassanger, isDriver);
